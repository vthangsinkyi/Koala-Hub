...
if Fluent then
    ...
    local Tabs = {
        ...
        Farming = Window:AddTab({ Title = "Farming", Icon = "leaf" }) -- New tab
    }
    ...
    Tabs.Main:AddToggle("AutoPublicRejoin", {
        ...
        Callback = function(value)
            ...
            if value then
                ...
                Tabs.Main:GetElement("AutoPrivateRejoin"):SetState(false)
            end
    ...
    Tabs.Main:AddToggle("AutoPrivateRejoin", {
        ...
        Callback = function(value)
            ...
            if value then
                ...
                Tabs.Main:GetElement("AutoPublicRejoin"):SetState(false)
            end
            saveSettings(settings)
        end
    })
    ...
    -- Farming Tab
    local u6 = require(ReplicatedStorage.Data.EnumRegistry.InventoryServiceEnums)
    local u29 = require(ReplicatedStorage.Modules.CalculatePlantValue)
    local u11 = require(ReplicatedStorage.Comma_Module)

    local function u28(p23)
        local v26 = {}
        if p23 then
            for _, v27 in pairs(p23:GetChildren()) do
                if v27:IsA("Tool") and (v27:FindFirstChild("Item_String") or v27:GetAttribute("PET_UUID")) and v27:GetAttribute(u6.Favorite) ~= true then
    ...
    local function u36(p30, p31, p32)
        local v33 = 0
        for _, v34 in p30 do
            local v35 = u29(v34)
            if p31 then
    ...
    Tabs.Farming:AddButton({
        ...
        Description = "Sells all non-favorited items in your inventory",
        Callback = function()
            local v50 = u28(LocalPlayer.Character)
            local v51 = u28(LocalPlayer.Backpack)
            local v52 = {}
            ...
            local v55 = u36(v52, true, ReplicatedStorage.GameEvents.Sell_Inventory)
            if v55 > 0 then
                showNotify("Success", "Sold items for " .. u11.Comma(tostring(v55)) .. " coins.", 5)
            else
