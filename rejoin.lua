‎-- Roblox Rejoin Script with Fluent UI
‎-- By [Day]
‎
...
‎        return game:GetService("ReplicatedStorage"):FindFirstChild("PrivateServerId") ~= nil or
‎               game:GetService("ReplicatedStorage"):FindFirstChild("PSID") ~= nil
‎    end)
‎    
...
‎                            Window:Notify({
‎                                Title = "Rejoining",
‎                                Content = "Rejoining public server...",
‎                                Duration = 5
‎                            })
‎                            task.wait(5)
‎                            TeleportService:Teleport(game.PlaceId)
